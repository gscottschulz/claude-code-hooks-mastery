...
2. Add the heading: `## Audio Summary for Scott`
3. Craft a message that speaks DIRECTLY to Scott about what you did for them
...
- **Address Scott directly** when appropriate: "Scott, I've updated your..." or "Fixed the bug in..." 
- **Focus on outcomes** for the user: what they can now do, what's been improved
- **Be conversational** - speak as if telling Scott what you just did
...
## Audio Summary for Scott

Scott, I've created three new output styles to customize how you receive information.

```bash
uv run .claude/hooks/utils/tts/elevenlabs_tts.py "Scott, I've created three new output styles to customize how you receive information."
```
